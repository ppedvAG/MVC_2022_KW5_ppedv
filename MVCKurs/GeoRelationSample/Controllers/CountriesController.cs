...
namespace GeoRelationSample.Controllers
{
    public class CountriesController : Controller
    {
        ...
        {
            var geoDbContext = _context.Countries.Include(c => c.ContinentRef);
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Population,Capital,ContinentId")] Country country)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Population,Capital,ContinentId")] Country country)
        {
            if (id != country.Id)
            {
                return NotFound();
